...
const QrCode: React.FC<QrCodeProps> = ({
  ...
  <path fillRule="evenodd" clipRule="evenodd" d="M20 3C20.5523 3 21 3.44772 21 4V9C21 9.55228 20.5523 10 20 10H15C14.7348 10 14.4805 9.89457 14.293 9.70703C14.1054 9.5195 14 9.26521 14 9V4C14 3.73479 14.1054 3.4805 14.293 3.29297C14.4805 3.10543 14.7348 3 15 3H20ZM16 8H19V5H16V8Z" fill={color}/>
