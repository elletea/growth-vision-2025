...
export interface ImagePlusProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ImagePlus: React.FC<ImagePlusProps> = ({
  size = 24,
  color = 'currentColor',
  className,
  style,
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 5.5H3.5V18.5H20.5V14H22.5V19.5C22.5 20.0523 22.0523 20.5 21.5 20.5H2.5C1.94772 20.5 1.5 20.0523 1.5 19.5V4.5C1.5 3.94771 1.94772 3.5 2.5 3.5H12V5.5Z" fill={color}/>
  ...
  <path d="M20 6H24V8H20V12H18V8H14V6H18V2H20V6Z" fill={color}/>
