...
export interface EmotionNeutralProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const EmotionNeutral: React.FC<EmotionNeutralProps> = ({
  size = 24,
  color = 'currentColor',
  className,
  style,
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M16 16H8V14H16V16Z" fill={color}/>
